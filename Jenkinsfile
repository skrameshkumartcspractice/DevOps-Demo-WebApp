...
pipeline {
    ...
    stages {
        ...
        stage('build') {
            ...
            post{
                always{
                    jiraSendBuildInfo branch: 'DEV-6', site: 'tcsdevopscs.atlassian.net'
                }                
            }
        }        
        stage('Test Deploy') {
            ...
            post{
                always{
                    jiraAddComment comment: "Deploy to Test was successful ${env.JOB_NAME} ${BUILD_NUMBER}", idOrKey: 'DEV-6', site: 'jira'
                    ...
                    jiraTransitionIssue idOrKey: 'DEV-6', input: transitionInputInP, site: 'jira'
                }
            }            
        }                
        stage('Artifactory') {
        ...
        stage('Prod Deploy') {
            ...
            post{
                always{
                    jiraAddComment comment: "Deploy to Prod was successful ${JOB_NAME} ${BUILD_NUMBER}", idOrKey: 'DEV-6', site: 'jira'
                    ...
                    jiraTransitionIssue idOrKey: 'DEV-6', input: transitionInputDone, site: 'jira'
                }
            }            
        }                                          
        stage('Sanity test') {
